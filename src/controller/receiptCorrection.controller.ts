...
import * as correctionService from '../services/receiptCorrection.service';
...
export const receiptCorrectionController = {
  async create(req: Request, res: Response) {
    return created(res, await correctionService.createReceiptCorrection(requireAuth(req), req.body));
  },

  async list(req: Request, res: Response) {
    const result = await correctionService.listReceiptCorrections(
      requireAuth(req),
